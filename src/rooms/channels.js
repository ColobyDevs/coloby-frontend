...
const Channels = ()=>{
    ...
    return(
        ...
        <div className="px-4 pt-4 text-sm font-medium flex flex-row justify-between items-center">
            <div>
            <h1>
            Welcome to #Coloby_Front end channel
                </h1>
                <span className="field-text font-normal">This channel is for everything Front end. Hold meetings, share docs, and make decisions together with your team.</span>
            </div>
