...
export default function Analysis(){
    return (
    <section className="ml-4 mt-4 flex flex-row gap-x-4">
...
<div className="h-40 w-32  ">
   ...
   <circle cx={100} cy={100} r={50} fill="white"/>
    <VictoryPie
      ...
      data={[
        { x: 1, y: 198 }, { x: 2, y: 126 }, { x: 3, y: 36 }
      ]}
      innerRadius={75} labelRadius={20}
      style={{
        data: {
          fillOpacity: 0.9,
        },
        labels: {
          fontSize: 25, fill: "#c43a31", visibility: 'hidden'
        },
        parent: {
            marginTop: 20
        }
