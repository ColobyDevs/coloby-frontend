...
const Signup = ()=>{
    ...
    return(
        <React.Fragment>
            ...
            <h3 className="text-blue-500 font-medium">Signup</h3>
            ...
            <Input type="text" id='phoneNumber' name= 'Phone Number'  validator = {[VALIDATOR_MINLENGTH(11)]} onInput={inputHandler} errMsg= "Invalid"/>
