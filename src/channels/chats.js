...
return(
    ...
    <section ref={carousel}  className="  rounded-md section-chat chat-con relative  mt-4 h-64 w-56 mx-auto bg-gray-900 overflow-x-hidden overflow-scroll scroll-smooth">
    ...
    <div className="bg-gray-900 sticky top-0  bottom-0 pb-2  left-0  mt-4 w-full px-2 flex flex-row items-center justify-between gap-x-2">
        ...
        <input value={state.value} onChange={messageHandler} placeholder="Message" className=" text-xs w-full focus:outline-none px-2  chat-message-box "/>
            </div>
